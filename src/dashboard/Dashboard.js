  ...
  return (
    <div className="lms-list__container mt-5 p-4">
      <h1 className="text-center mb-5">
        Welcome to{" "}
        <img src="https://s3-ap-southeast-2.amazonaws.com/lms.techcrafting.net/lms_brand.png" height="60px" />
      </h1>

      <div className="row justify-content-around">
        <div className="col-md-6 col-lg-5 px-0 px-sm-5">
          <div className="card text-white bg-info mb-5 lms-shadow">
            ...
            <div className="card-body">
              ...
              <Link className="btn btn-outline-light my-2 my-lg-0" to={`/courses/create`}>
                New Course
              </Link>
            </div>
          </div>
        ...
        <div className="col-md-6 col-lg-5 px-0 px-sm-5">
          <div className="card text-white bg-success mb-5 lms-shadow">
            ...
            <div className="card-body">
              ...
              <Link className="btn btn-outline-light my-2 my-lg-0" to={`/lecturers/create`}>
                New Lecturer
              </Link>
            </div>
          </div>
        ...
        <div className="col-md-6 col-lg-5 px-0 px-sm-5">
          <div className="card text-dark bg-warning mb-5 lms-shadow">
            ...
            <div className="card-body">
              ...
              <Link className="btn btn-outline-dark my-2 my-lg-0" to={`/students/create`}>
                New Student
              </Link>
            </div>
          </div>
